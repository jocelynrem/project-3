            ...
            <div className="items-center justify-center pb-5">
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col m-2 md:mr-16">
                            ...
                            required
                            className="text-gray-600 focus:outline-none focus:border focus:border-lt-green bg-white font-normal w-64 h-10 flex items-center pl-2 text-sm border-gray-300 rounded border shadow" placeholder="Password" />
                        </div>
                    </div>
